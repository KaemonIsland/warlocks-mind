class ToolsController < ApplicationController
  ...
  # GET /tools.json
  def index
    @tools = Tool.user_tools current_user
  end
  ...
  private
    ...
    def tool_params
      params.require(:tool).permit(:category, :name, :notes, :cost_amount, :cost_type, :weight)
    end

    def has_permission?
      require_permission Tool.find(params[:id]).user
    end
end
